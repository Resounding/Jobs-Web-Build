...
define('resources/views/calendar/calendar',["require", "exports", "../../services/data/db", "aurelia-router", "aurelia-framework", "aurelia-templating", "aurelia-dependency-injection", "aurelia-event-aggregator", "../../models/foreman", "../../models/job-type", "../../services/data/job-service", "../../services/notifications", "./event-popup"], function (require, exports, db_1, aurelia_router_1, aurelia_framework_1, aurelia_templating_1, aurelia_dependency_injection_1, aurelia_event_aggregator_1, foreman_1, job_type_1, job_service_1, notifications_1, event_popup_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Calendar = (function () {
        ...
        Calendar.prototype.getViewHtml = function (job) {
            ...
            view.bind(new event_popup_1.EventPopup(job));
