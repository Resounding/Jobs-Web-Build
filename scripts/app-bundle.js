...
define('resources/services/config',["require", "exports"], function (require, exports) {
    ...
    var Configuration = (function () {
        ...
        Configuration.isMobile = function () {
...
define('resources/views/app',["require", "exports", "../services/auth", "text!../../../package.json"], function (require, exports, auth_1, data) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var App = (function () {
        function App() {
...
define('resources/services/data/db',["require", "exports", "aurelia-event-aggregator", "aurelia-framework", "../../models/job", "../config", "../log", "../auth"], function (require, exports, aurelia_event_aggregator_1, aurelia_framework_1, job_1, config_1, log_1, auth_1) {
                            ...
                            change.change.docs.forEach(function (doc) {
                                if (doc.type === job_1.JobDocument.DOCUMENT_TYPE) {
                                    ...
                                    if (job._rev.substring(0, 2) === '1-') {
                                        ...
                                        _this.events.publish(Database_1.DocumentUpdatedEvent, job);
                                    }
                                }
                                else if (doc._deleted) {
                                    _this.events.publish(Database_1.SyncChangeEvent, job);
                                    _this.events.publish(Database_1.DocumentDeletedEvent, doc._id);
                                }
                            });
                        }
                    }
    ...
    Database.DocumentCreatedEvent = 'DocumentCreatedEvent';
    Database.DocumentUpdatedEvent = 'DocumentUpdatedEvent';
    Database.DocumentDeletedEvent = 'DocumentDeletedEvent';
...
define('resources/views/calendar/calendar',["require", "exports", "../../services/config", "aurelia-router", "aurelia-framework", "aurelia-templating", "aurelia-dependency-injection", "aurelia-event-aggregator", "../../models/foreman", "../../models/job-type", "../../services/data/db", "../../services/data/job-service", "../../services/notifications", "./event-popup"], function (require, exports, config_1, aurelia_router_1, aurelia_framework_1, aurelia_templating_1, aurelia_dependency_injection_1, aurelia_event_aggregator_1, foreman_1, job_type_1, db_1, job_service_1, notifications_1, event_popup_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Calendar = (function () {
        function Calendar(jobService, router, element, events, viewLocator, viewEngine, container) {
        ...
        Calendar.prototype.activate = function (params, routeConfig, navigationInstruction) {
            this.createdSubscription = this.events.subscribe(db_1.Database.DocumentCreatedEvent, this.onDocumentCreated.bind(this));
            this.updatedSubscription = this.events.subscribe(db_1.Database.DocumentUpdatedEvent, this.onDocumentUpdated.bind(this));
            this.deletedSubscription = this.events.subscribe(db_1.Database.DocumentDeletedEvent, this.onDocumentDeleted.bind(this));
        ...
        Calendar.prototype.attached = function () {
            var _this = this;
            var strategy = this.viewLocator.getViewStrategy('resources/views/calendar/event-popup.html');
            strategy.loadViewFactory(this.viewEngine, new aurelia_templating_1.ViewCompileInstruction())
                .then(function (vf) {
                _this.viewFactory = vf;
                _this.jobService
                    .getAll()
                    .then(function (items) {
                    var events = items
                        .filter(function (i) { return i.startDate; })
                        .map(_this.createEvent, _this);
                    var options = {
                    ...
                    if (config_1.Configuration.isMobile()) {
                        _.extend(options, {
                            height: 'auto',
                            selectable: true,
                    ...
                    _this.cal = $('#calendar', _this.element).fullCalendar(options);
                });
            });
        };
        Calendar.prototype.toggleOptionsExpanded = function () {
        ...
        Calendar.prototype.onSelect = function (start) {
        ...
        Calendar.prototype.onDocumentCreated = function (doc) {
            console.log("document created:");
            console.log(doc);
            var event = this.createEvent(doc);
            this.cal.fullCalendar('addEventSource', [event]);
        };
        Calendar.prototype.onDocumentUpdated = function (doc) {
            console.log("document updated:");
            console.log(doc);
            var events = this.getCalendarEvents(doc._id);
            if (_.isArray(events) && events.length) {
                var event_1 = events[0];
                this.createEvent(doc, event_1);
                this.cal.fullCalendar('updateEvent', event_1);
            }
        };
        Calendar.prototype.onDocumentDeleted = function (id) {
        ...
        Calendar.prototype.getCalendarEvents = function (id) {
            return this.cal.fullCalendar('clientEvents', id);
        };
        Calendar.prototype.createEvent = function (job, originalEvent) {
            var foreman = (job.foreman || '').toLowerCase(), backgroundColor = foreman_1.Foreman.BackgroundColours[foreman] || 'white', popup = this.getViewHtml(job);
            var baseObject = (_.isObject(originalEvent) && originalEvent.id) ? originalEvent : {}, event = _.extend(baseObject, job, {
                id: job._id,
                title: job.number,
                ...
                textColor: '#000',
                url: config_1.Configuration.isMobile() ? null : this.router.generate('jobs.edit', { id: job._id }),
                end: job.endDate ? moment(job.endDate).add(1, 'day').format('YYYY-MM-DD') : null,
                popup: popup
            });
            return event;
        };
        Calendar.prototype.getViewHtml = function (job) {
            var view = this.viewFactory.create(this.container);
            view.bind(new event_popup_1.EventPopup(job, this.router));
            var fragment = view.fragment, div = document.createElement('div');
    ...
    Calendar = __decorate([
        aurelia_framework_1.autoinject,
        __metadata("design:paramtypes", [job_service_1.JobService, aurelia_router_1.Router, Element, aurelia_event_aggregator_1.EventAggregator,
            aurelia_templating_1.ViewLocator, aurelia_templating_1.ViewEngine, aurelia_dependency_injection_1.Container])
    ], Calendar);
...
define('resources/views/calendar/event-popup',["require", "exports", "../../models/foreman", "../../models/job-type", "../../models/job-status"], function (require, exports, foreman_1, job_type_1, job_status_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var EventPopup = (function () {
        function EventPopup(job, router) {
            this.job = job;
            this.router = router;
            this.jobStatuses = job_status_1.JobStatus.OPTIONS;
        }
        Object.defineProperty(EventPopup.prototype, "startDateDisplay", {
            get: function () {
        ...
        Object.defineProperty(EventPopup.prototype, "endDateDisplay", {
            get: function () {
                var display = '';
                if (this.job.endDate) {
        ...
        Object.defineProperty(EventPopup.prototype, "jobStatus", {
            get: function () {
                var _this = this;
        ...
        Object.defineProperty(EventPopup.prototype, "foremanDisplay", {
            get: function () {
        ...
        Object.defineProperty(EventPopup.prototype, "foremanColour", {
            get: function () {
                var foreman = (this.job.foreman || '').toLowerCase(), bg = foreman_1.Foreman.BackgroundColours[foreman] || 'white', color = bg === 'white' ? 'black' : 'white', margin = '1px';
                return { 'background-color': bg, color: color, margin: margin };
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(EventPopup.prototype, "isProject", {
            get: function () {
        ...
        Object.defineProperty(EventPopup.prototype, "isServiceCall", {
            get: function () {
        ...
        Object.defineProperty(EventPopup.prototype, "jobNumberDisplay", {
            get: function () {
        ...
        Object.defineProperty(EventPopup.prototype, "routeHref", {
            get: function () {
                var href = this.router.generate('jobs.edit', { id: this.job._id });
                return href;
            },
            enumerable: true,
            configurable: true
...
define('resources/views/jobs/list-item',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../../models/job-status", "../../models/job-type", "../../models/foreman", "../../services/data/job-service", "../../services/notifications", "../../services/auth", "./close-job"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, job_status_1, job_type_1, foreman_1, job_service_1, notifications_1, auth_1, close_job_1) {
    ...
    var ListItem = (function () {
        ...
        Object.defineProperty(ListItem.prototype, "foremanColour", {
            get: function () {
                var foreman = (this.job.foreman || '').toLowerCase(), bg = foreman_1.Foreman.BackgroundColours[foreman] || 'white', color = bg === 'white' ? 'black' : 'white', margin = '1px';
                return { 'background-color': bg, color: color, margin: margin };
            },
